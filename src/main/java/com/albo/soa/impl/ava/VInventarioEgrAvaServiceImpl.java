...
import com.albo.soa.repository.ava.IVInventarioEgrAvaRepository;
import com.albo.soa.service.ava.IVInventarioEgrAvaService;

@Service
public class VInventarioEgrAvaServiceImpl implements IVInventarioEgrAvaService {

	@Autowired
	private IVInventarioEgrAvaRepository vInventarioEgrAvaRepo;

	@Override
	public List<VInventarioEgr> listarVInventarioEgr(String fechaSalida, String recinto, String estado,
			String fechaInicial, String fechaFinal) {
		return vInventarioEgrAvaRepo.listarVInventarioEgr(fechaSalida, recinto, estado, fechaInicial, fechaFinal);
	}
