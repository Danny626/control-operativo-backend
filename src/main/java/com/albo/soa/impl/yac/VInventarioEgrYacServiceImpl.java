...
import com.albo.soa.repository.yac.IVInventarioEgrYacRepository;
import com.albo.soa.service.yac.IVInventarioEgrYacService;

@Service
public class VInventarioEgrYacServiceImpl implements IVInventarioEgrYacService {

	@Autowired
	private IVInventarioEgrYacRepository vInventarioEgrYacRepo;

	@Override
	public List<VInventarioEgr> listarVInventarioEgr(String fechaSalida, String recinto, String estado,
			String fechaInicial, String fechaFinal) {
		return vInventarioEgrYacRepo.listarVInventarioEgr(fechaSalida, recinto, estado, fechaInicial, fechaFinal);
	}
