...
import com.albo.soa.repository.tam.IVInventarioEgrTamRepository;
import com.albo.soa.service.tam.IVInventarioEgrTamService;

@Service
public class VInventarioEgrTamServiceImpl implements IVInventarioEgrTamService {

	@Autowired
	private IVInventarioEgrTamRepository vInventarioEgrTamRepo;

	@Override
	public List<VInventarioEgr> listarVInventarioEgr(String fechaSalida, String recinto, String estado,
			String fechaInicial, String fechaFinal) {
		return vInventarioEgrTamRepo.listarVInventarioEgr(fechaSalida, recinto, estado, fechaInicial, fechaFinal);
	}
