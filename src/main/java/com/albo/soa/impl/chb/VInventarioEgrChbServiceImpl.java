...
import com.albo.soa.repository.chb.IVInventarioEgrChbRepository;
import com.albo.soa.service.chb.IVInventarioEgrChbService;

@Service
public class VInventarioEgrChbServiceImpl implements IVInventarioEgrChbService {

	@Autowired
	private IVInventarioEgrChbRepository vInventarioEgrChbRepo;

	@Override
	public List<VInventarioEgr> listarVInventarioEgr(String fechaSalida, String recinto, String estado,
			String fechaInicial, String fechaFinal) {
		return vInventarioEgrChbRepo.listarVInventarioEgr(fechaSalida, recinto, estado, fechaInicial, fechaFinal);
	}
